<#
  ...
  - Deletes statusline_model.ps1, usage_refresh.ps1, and the usage cache/locks.
  - KEEPS widget_refresh.ps1: the Claude_Usage widget spawns it to refresh
    widget_limits.json, independently of the status line. Deleting it breaks the
    widget's live limits.
...
$removed = 0
foreach ($f in 'statusline_model.ps1','usage_refresh.ps1','_usage5h.json','_usage.lock','_widget.lock') {
